...
const UserProfile = () => {
    ...
    const { getFollowing, followingUsers, getFollowers, followersUsers, followUser, unfollowUser } = useContext(UserContext)
                ...
                <div class="modal-dialog" style={{ marginTop: '30vh' }}>
                    <div class="modal-content">
                        ...
                        <div class="modal-body" style={{ overflowY: 'scroll' }}>
                            ...
                            }) : <h3 style={{ textAlign: 'center', marginBottom: '20px' }}>No following us</h3>}
                        </div>
                    </div>
                </div>
            </div>
                        ...
                        <div className="col col-lg-9 col-xl-7">
                            <div className="card" style={{ width: '40vw' }}>
                                <div className="rounded-top text-white d-flex flex-row" style={{ backgroundColor: '#000', height: '200px' }}>
                                    <div className="ms-4 mt-5 d-flex flex-column" style={{ width: "150px" , height:'250px'}}>
                                        <img src={`${u?.profilepic ? u?.profilepic : profilepic}`}
                                            alt="Generic placeholder image" className="img-fluid img-thumbnail mt-4 mb-3"
                                            style={{ width: '150px', zIndex: "1", height:'150px'}} />
                                        {isFollowed ? <button type="button" className="btn btn-outline-dark" data-mdb-ripple-color="dark"
                                            style={{ zIndex: "1" }} onClick={onUnfollowUser}>
                                            Unollow
                                        </button>:<button type="button" className="btn btn-outline-dark" data-mdb-ripple-color="dark"
                                            style={{ zIndex: "1" }} onClick={onFollowUser}>
                                            Follow
                                        </button>}
                                    </div>
                                ...
                                <div className="p-4 text-black" style={{ backgroundColor: "#f8f9fa" }}>
                                    <div className="d-flex justify-content-end text-center py-1">
                                        ...
                                        <div className="px-3" style={{ cursor: 'pointer' }} data-bs-toggle="modal" data-bs-target="#followersModal" onClick={()=>getFollowers(u?._id)}>
                                            <p className="mb-1 h5">{u?.followers?.length}</p>
                                            <p className="small mb-0">Followers</p>
                                        </div>
                                        <div style={{ cursor: 'pointer' }} data-bs-toggle="modal" data-bs-target="#followingModal" onClick={()=>getFollowing(u?._id)}>
                                            <p className="mb-1 h5">{u?.following?.length}</p>
                                ...
                                <div className="card-body p-4 text-black">
                                    <div className="mb-5">
                                        ...
                                        <div className="p-4" style={{ backgroundColor: "#f8f9fa" }}>
                                            <p className="font-italic mb-1">{u?.about}</p>
                                        </div>
                                    </div>
